...
public class GcmInstanceIdRefreshHandlerService extends IntentService {
    ...
    public static final String ACTION_APP_LAUNCH = "com.wix.reactnativenotifications.gcm.ACTION_APP_LAUNCH";
    public static final String ACTION_MANUAL_REFRESH = "com.wix.reactnativenotifications.gcm.ACTION_MANUAL_REFRESH";

    private static final String PREFS_NAME = "com.wix.reactnativenotifications.gcm.token";
    private static final String PREF_REFRESH_INCOMPLETE = "refreshIncomplete";
    private static final String PREF_TOKEN_AQUIRED = "tokenAquired";
    ...
    private void onTokenRefreshed() {
        try {
            ...
            preferencesEditor.putBoolean(PREF_REFRESH_INCOMPLETE, true);//refreshIncomplete);
